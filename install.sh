...
# Usage: curl -fsSL https://raw.githubusercontent.com/ColdDesertLab/ExamOS-2026/master/install.sh | bash

set -e

REPO="https://github.com/ColdDesertLab/ExamOS-2026.git"
INSTALL_DIR="$HOME/.examos-2026"
LAUNCHER="$HOME/.local/bin/examos-2026"
...
echo -e "  ${GREEN}examos-2026${NC}                         — open ExamOS in browser"
echo -e "  ${GREEN}EXAMOS_PORT=9000 examos-2026${NC}        — custom port"
echo -e "  ${GREEN}EXAMOS_NO_UPDATE=1 examos-2026${NC}      — skip auto-update"
echo
